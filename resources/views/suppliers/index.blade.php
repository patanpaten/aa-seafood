...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight uppercase">Master Supplier</h1>
            <p class="text-slate-500 font-medium text-sm mt-1">Daftar pemasok seafood utama Anda.</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 border-b border-slate-100">
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Nama Supplier</th>
                    ...
                    <tr>
                        <td colspan="4" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-slate-400 font-medium italic">Belum ada data supplier.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse

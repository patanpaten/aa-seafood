        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-8 sm:p-12">
                <div class="flex items-center space-x-4 mb-10">
                    ...
                    <div>
                        <h1 class="text-2xl font-extrabold text-slate-900 uppercase tracking-tight">Edit Supplier</h1>
                        <p class="text-slate-500 text-sm font-medium">Perbarui informasi pemasok seafood.</p>
                    </div>
                </div>
                ...
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="name" class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-1">Nama Supplier</label>
                            <input type="text" name="name" id="name" value="{{ $supplier->name }}" placeholder="Masukkan nama supplier"
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" placeholder="Alamat lengkap supplier"

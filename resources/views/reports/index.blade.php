...
@section('title', 'Laporan Stok & Penjualan')

@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight uppercase">Laporan Inventaris</h1>
            <p class="text-slate-500 font-medium text-sm mt-1">Rekapitulasi stok dan penjualan seafood Anda.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-colors">
            ...
            <p class="text-[10px] font-bold text-blue-400 uppercase tracking-[0.2em] mb-3">Total Masuk</p>
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-rose-200 transition-colors">
            ...
            <p class="text-[10px] font-bold text-rose-400 uppercase tracking-[0.2em] mb-3">Total Susut</p>
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden group hover:border-emerald-200 transition-colors">
            ...
            <p class="text-[10px] font-bold text-emerald-400 uppercase tracking-[0.2em] mb-3">Total Jual</p>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
        <div class="px-8 py-6 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
            <h3 class="text-sm font-extrabold text-slate-900 uppercase tracking-widest">Detail Per Jenis Seafood</h3>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/20 border-b border-slate-100">
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Jenis</th>
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Masuk (Periode)</th>
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Keluar (Periode)</th>
                        <th class="px-8 py-5 text-[10px] font-bold text-blue-400 uppercase tracking-[0.2em]">Stok Saat Ini</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-50">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-8 py-12 text-center text-slate-400 font-medium italic">Tidak ada data untuk periode ini.</td>
                    </tr>
                    @endforelse
                </tbody>

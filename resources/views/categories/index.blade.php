...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight uppercase">Daftar Barang</h1>
            <p class="text-slate-500 font-medium text-sm mt-1">Daftar barang yang Anda jual atau simpan.</p>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 border-b border-slate-100">
                        ...
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Harga Biasa</th>
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Harga Banyak</th>
                        <th class="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Foto</th>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-8 py-6">
                            <div class="inline-flex items-center gap-3 px-4 py-3 rounded-2xl bg-blue-50 border border-blue-100">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-xl bg-white text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Biasa</span>
                                <span class="text-sm font-extrabold text-blue-700">Rp {{ number_format($category->retail_price, 0, ',', '.') }}</span>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                            <div class="inline-flex items-center gap-3 px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-100">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-xl bg-white text-[10px] font-black text-emerald-500 uppercase tracking-[0.2em]">Banyak</span>
                                <span class="text-sm font-extrabold text-emerald-700">Rp {{ number_format($category->wholesale_price, 0, ',', '.') }}</span>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                        ...
                        <td class="px-8 py-6 text-center">
                            <div class="flex items-center justify-center space-x-3">
                                ...
                                <form action="{{ route('categories.destroy', $category) }}" method="POST" onsubmit="return confirm('Hapus barang ini?')">
                                    @csrf @method('DELETE')
                    ...
                    <tr>
                        <td colspan="6" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-slate-400 font-medium italic">Belum ada data barang.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse

...
@section('title', 'Master Partner')

@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight uppercase">Master Partner</h1>
            <p class="text-slate-500 font-medium text-sm mt-1">Daftar mitra restoran Anda.</p>
        </div>
                    ...
                    <tr>
                        <td colspan="4" class="px-8 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-slate-400 font-medium italic">Belum ada data partner.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse

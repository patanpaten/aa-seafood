        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-8 sm:p-12">
                <div class="flex items-center space-x-4 mb-10">
                    ...
                    <div>
                        <h1 class="text-2xl font-extrabold text-slate-900 uppercase tracking-tight">Tambah Pelanggan</h1>
                        <p class="text-slate-500 text-sm font-medium">Masukkan data pelanggan restoran baru.</p>
                    </div>
                </div>
